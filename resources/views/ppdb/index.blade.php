    ...
    <div class="page-content">
        ...
        <div class="card border-top border-0 border-4 border-primary">
            <div class="card-body p-5">
                ...
                <hr>
                <form class="row g-3" method="POST" action="{{ route('ppdb.submit') }}" enctype="multipart/form-data">
        ...
        } elseif ($rata2 <= 50) { $alertClass='alert-danger' ; } elseif ($rata2> 50) {
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <div class="alert {{ $alertClass }}">
                        ...
                        <strong>Status:</strong> Pendaftaran berhasil. Admin belum menetapkan jadwal tes. Silakan cek
                        kembali nanti.
                        ...
                        @elseif ($rata2 <= 50) <strong>Mohon Maaf.</strong> Anda <span class="text-danger">tidak lulus
                                seleksi</span> berdasarkan hasil tes.<br>
                            Terima kasih telah mengikuti seleksi penerimaan siswa baru.
                            @elseif ($rata2 > 50 && $ppdb->status_daftar_ulang == 0)
                            <strong>Selamat!</strong> Anda <span class="text-success">dinyatakan lulus
                                seleksi</span>.<br>
                            Silakan melakukan <strong>daftar ulang</strong> lalu kirimkan bukti daftar ulang melalui
                            tombol di bawah ini. Daftar ulang memerlukan validasi, cek secara berkala untuk melihat
                            status daftar ulang.
                            ...
                            <div class="modal fade" id="modalHasilTes" tabindex="-1"
                                aria-labelledby="modalHasilTesLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body" id="printArea">
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Wawancara</td>
                                                        <td class="text-center">{{ $ppdb->hasilTes->wawancara }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Baca Tulis</td>
                                                        <td class="text-center">{{ $ppdb->hasilTes->baca_tulis }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Baca Tulis Qur'an</td>
                                                        <td class="text-center">{{ $ppdb->hasilTes->btq }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Buta Warna</td>
                                                        <td class="text-center">{{ $ppdb->hasilTes->buta_warna }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Fisik</td>
                                                        <td class="text-center">{{ $ppdb->hasilTes->fisik }}</td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                    ...
                    <div class="modal fade" id="modalUploadBukti" tabindex="-1" aria-labelledby="modalUploadBuktiLabel"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('ppdb.uploadBukti', $ppdb->id) }}" method="POST"
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="bukti_daftar_ulang" class="form-label">Pilih File
                                            (PDF/JPG/PNG)</label>
                                        <input type="file" class="form-control" id="bukti_daftar_ulang"
                                            name="bukti_daftar_ulang" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
